// CampusAnon — Option 2: Deep Purple Night

export const theme = {
  bg: 'transparent',
  bgCard: 'rgba(120,80,255,0.06)',
  bgSurface: 'rgba(120,80,255,0.08)',
  bgHover: 'rgba(120,80,255,0.1)',
  border: 'rgba(155,127,232,0.15)',
  neon: '#9b7fe8',
  neonDim: 'rgba(155,127,232,0.12)',
  neonGlow: '0 0 24px rgba(155,127,232,0.3)',
  text: '#f0ecff',
  textMuted: 'rgba(240,236,255,0.4)',
  textDim: 'rgba(240,236,255,0.15)',
  success: '#7dba84',
  error: '#c97676',
  gradient: 'linear-gradient(135deg, #9b7fe8 0%, #6b4fc8 100%)',
};
...
export const styles = {
  ...
  header: {
    ...
    background: 'rgba(8,0,24,0.7)', backdropFilter: 'blur(28px)',
    WebkitBackdropFilter: 'blur(28px)',
    position: 'sticky', top: 0, zIndex: 100,
    borderBottom: '1px solid rgba(155,127,232,0.1)',
  },
  headerLogo: {
  ...
  aliasTag: {
    background: theme.neonDim, border: '1px solid rgba(155,127,232,0.25)',
    padding: '5px 16px', borderRadius: 20, fontSize: 11,
    color: theme.neon, fontFamily: mono, letterSpacing: 2,
  },
  logoutBtn: {
    background: 'none', border: '1px solid rgba(155,127,232,0.15)',
    borderRadius: 8, padding: '6px 16px', cursor: 'pointer',
    fontSize: 12, color: theme.textMuted, fontFamily: RC,
    fontWeight: 600, letterSpacing: 1, textTransform: 'uppercase', transition: 'all 0.2s',
  },

  // ── Sidebar ───────────────────────────────────────────────────────────────
  sidebar: {
    width: 236, background: 'rgba(8,0,24,0.6)', backdropFilter: 'blur(28px)',
    WebkitBackdropFilter: 'blur(28px)',
    borderRight: '1px solid rgba(155,127,232,0.1)',
  ...
  sidebarAvatar: {
    ...
    boxShadow: '0 4px 20px rgba(155,127,232,0.4)',
  },
  sidebarAlias: { fontWeight: 700, fontSize: 14, color: theme.text, fontFamily: mono, letterSpacing: 0.5 },
  sidebarGender: { color: theme.textMuted, fontSize: 12, marginTop: 3, fontFamily: RC },
  sidebarDivider: { border: 'none', borderTop: '1px solid rgba(155,127,232,0.1)', margin: '10px 0' },
  sidebarItem: {
  ...
  statBox: {
    ...
    border: '1px solid rgba(155,127,232,0.12)',
  ...
  authCard: {
    ...
    boxShadow: '0 40px 100px rgba(80,40,180,0.2)',
    position: 'relative', overflow: 'hidden',
  },
  authCardTopLine: {
    position: 'absolute', top: 0, left: 0, right: 0, height: 1,
    background: 'linear-gradient(90deg, transparent, rgba(155,127,232,0.7), transparent)',
  },
  authTitle: {
  ...
  authSubtitle: {
    ...
    fontSize: 13, lineHeight: 1.7, letterSpacing: 0.3,
  },
  infoBox: {
  ...
  input: {
    ...
    border: '1px solid rgba(155,127,232,0.15)', borderRadius: 12, fontSize: 14,
    boxSizing: 'border-box', fontFamily: RC, fontWeight: 400,
    background: 'rgba(120,80,255,0.06)', color: theme.text,
  ...
  genderBtn: {
    flex: 1, padding: '11px 4px', border: '1px solid rgba(155,127,232,0.15)',
    borderRadius: 10, background: 'rgba(120,80,255,0.05)', cursor: 'pointer',
  ...
  primaryBtn: {
    ...
    boxShadow: '0 4px 24px rgba(155,127,232,0.3)',
    transition: 'all 0.2s',
  },
  ...
  // ── Pages ─────────────────────────────────────────────────────────────────
  pageTitle: {
    fontSize: 30, fontWeight: 800, marginBottom: 8, fontFamily: RC,
    color: theme.text, letterSpacing: 3, textTransform: 'uppercase',
    display: 'flex', alignItems: 'center', gap: 12,
  },
  pageSubtitle: { color: theme.textMuted, marginBottom: 38, fontSize: 14 },
  matchBanner: {
  ...
  profileCard: {
    ...
    backdropFilter: 'blur(40px)', WebkitBackdropFilter: 'blur(40px)',
    border: '1px solid rgba(155,127,232,0.15)',
    borderRadius: 24, padding: '44px 40px', width: 380,
    textAlign: 'center', position: 'relative', overflow: 'hidden',
    boxShadow: '0 30px 80px rgba(80,40,180,0.2)',
  ...
  profileAvatar: {
    ...
    boxShadow: '0 8px 32px rgba(155,127,232,0.4)',
  },
  profileAlias: {
  ...
  profileBio: {
    color: 'rgba(240,236,255,0.5)', fontSize: 13, fontStyle: 'italic',
    marginBottom: 20, lineHeight: 1.7,
    borderLeft: '2px solid rgba(155,127,232,0.3)', paddingLeft: 14, textAlign: 'left',
  },
  ...
  passBtn: {
    ...
    border: '1px solid rgba(155,127,232,0.15)', color: theme.textMuted,
  ...
  likeBtn: {
    ...
    boxShadow: '0 4px 20px rgba(155,127,232,0.35)', transition: 'all 0.2s',
  },
  cardCounter: {
  ...
  matchCard: {
    background: 'rgba(120,80,255,0.07)', backdropFilter: 'blur(28px)',
    border: '1px solid rgba(155,127,232,0.15)',
    borderRadius: 20, padding: 28, textAlign: 'center',
    transition: 'all 0.2s', position: 'relative', overflow: 'hidden',
    boxShadow: '0 10px 40px rgba(80,40,180,0.15)',
  },
  matchAvatar: {
    width: 68, height: 68, borderRadius: '50%', background: theme.gradient, color: '#fff',
    display: 'flex', alignItems: 'center', justifyContent: 'center',
    fontSize: 28, fontWeight: 800, margin: '0 auto 14px',
    fontFamily: RC, boxShadow: '0 4px 16px rgba(155,127,232,0.3)',
  },
  ...
  chatList: {
    width: 280, background: 'rgba(8,0,24,0.5)', backdropFilter: 'blur(28px)',
    borderRight: '1px solid rgba(155,127,232,0.1)',
  ...
  chatListTitle: {
    ...
    borderBottom: '1px solid rgba(155,127,232,0.08)',
  },
  chatListItem: {
    display: 'flex', alignItems: 'center', gap: 14, padding: '14px 20px',
    cursor: 'pointer', borderBottom: '1px solid rgba(155,127,232,0.05)',
  ...
  msgBubbleMe: {
    ...
    boxShadow: '0 4px 16px rgba(155,127,232,0.25)',
  },
  msgBubbleThem: {
    background: 'rgba(155,127,232,0.1)', border: '1px solid rgba(155,127,232,0.15)',
  ...
  chatInputRow: {
    ...
    background: 'rgba(8,0,24,0.5)', backdropFilter: 'blur(28px)',
    borderTop: '1px solid rgba(155,127,232,0.08)', flexShrink: 0,
  },
  chatInput: {
    flex: 1, padding: '12px 22px',
    border: '1px solid rgba(155,127,232,0.15)', borderRadius: 50,
    fontSize: 14, fontFamily: RC,
    background: 'rgba(120,80,255,0.07)', color: theme.text,
    outline: 'none', transition: 'all 0.2s',
  },
  sendBtn: {
    ...
    boxShadow: '0 4px 16px rgba(155,127,232,0.3)',
  },
  ...
  profileEditCard: {
    background: 'rgba(120,80,255,0.07)', backdropFilter: 'blur(28px)',
    border: '1px solid rgba(155,127,232,0.15)',
    borderRadius: 20, padding: 44, maxWidth: 540,
    boxShadow: '0 30px 80px rgba(80,40,180,0.2)',
  },
  profileEditAvatar: {
  ...
  settingsCard: {
    background: 'rgba(120,80,255,0.07)', backdropFilter: 'blur(28px)',
    border: '1px solid rgba(155,127,232,0.15)',
    borderRadius: 20, padding: 44, maxWidth: 520, display: 'flex', flexDirection: 'column',
    boxShadow: '0 30px 80px rgba(80,40,180,0.2)',
  },
  settingRow: {
    display: 'flex', alignItems: 'center', justifyContent: 'space-between',
    padding: '18px 0', borderBottom: '1px solid rgba(155,127,232,0.08)',
  },
  ...
  footer: {
    background: 'rgba(8,0,24,0.7)', backdropFilter: 'blur(28px)',
    borderTop: '1px solid rgba(155,127,232,0.08)',
...
export const mobileStyles = {
  ...
  hamburgerLine: {
    ...
    background: 'rgba(240,236,255,0.7)', borderRadius: 2,
  },
  overlay: {
  ...
  drawer: {
    ...
    background: 'rgba(8,0,24,0.97)', backdropFilter: 'blur(28px)',
    borderRight: '1px solid rgba(155,127,232,0.15)',
    overflowY: 'auto',
  },
  sidebarMobile: {
  ...
  sidebarClose: {
    background: 'none', border: 'none', color: 'rgba(240,236,255,0.3)',
    fontSize: 18, cursor: 'pointer', alignSelf: 'flex-end',
    padding: '4px 8px', marginBottom: 16,
  },
  bottomNav: {
    position: 'fixed', bottom: 0, left: 0, right: 0, height: 64,
    background: 'rgba(8,0,24,0.97)', backdropFilter: 'blur(20px)',
    borderTop: '1px solid rgba(155,127,232,0.1)',
